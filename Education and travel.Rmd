...
```{r data read}
library(haven)
data <- read_dta("~/Box Sync/Research/Educational benefits/education and travel/eclsk_1998/data/initial_data_0515.dta")
...
library(mice)
data.mice <- mice(data_nt1,m=25,maxit=25,seed=500)
