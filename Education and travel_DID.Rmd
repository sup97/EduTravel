...
#load imputed data
setwd("~/Documents/GitHub/EduTravel")
load("~/Documents/GitHub/EduTravel/data_imp.RData")

data_nt_imp <- as.mids(data_nt_imp, .imp="_imp")

#setwd("~/Box Sync/education and travel/R")
#load("~/Box Sync/education and travel/R/data_knn.RData")
#summary(data.knn)
densityplot(data_nt_imp, ~reading|.data_nt_imp)
