...
data_nt_imp<- read_csv("C:/Users/sup97/Box Sync/Research/Educational benefits/education and travel (sup97@psu.edu)/R/mice_imp_5.csv")
...
write.csv(data, file="final_data_0226.csv", row.names = FALSE)
